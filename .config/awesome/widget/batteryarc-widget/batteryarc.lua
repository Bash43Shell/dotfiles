...
local PATH_TO_ICON = "/usr/share/icons/Arc/status/symbolic/battery-full-charged-symbolic.svg"
...
local function worker(args)
	...
	local font = args.font or 'Droid Serif 6'
	...
	local warning_msg_title = args.warning_msg_title or 'Kita Menghadapi Masalah'
	local warning_msg_text = args.warning_msg_text or 'Batre Dalam Keadaan kritis'
	local warning_msg_position = args.warning_msg_position or 'top_right'
	local warning_msg_icon = args.warning_msg_icon or HOME .. '/.config/awesome/widget/batteryarc-widget/spaceman.jpg'
