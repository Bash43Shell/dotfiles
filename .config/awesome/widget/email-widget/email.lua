...
watch(
"python /home/<username>/.config/awesome/widget/email-widget/count_unread_emails.py", 20,
...
function show_emails()
	awful.spawn.easy_async([[bash -c 'python /home/<username>/.config/awesome/widget/email-widget/read_unread_emails.py']],
